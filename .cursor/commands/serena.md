...
1. **Активуй проєкт:** `call_mcp_tool` → server `user-serena`, tool `activate_project`, args `{"project": "d:\\Project\\myprog\\fitapp"}`
2. Проєкт: `fitapp` (шлях: `d:\Project\myprog\fitapp`)

## Доступні інструменти (активні)

| Інструмент | Призначення |
|------------|-------------|
| `activate_project` | Активація проєкту (fitapp) |
